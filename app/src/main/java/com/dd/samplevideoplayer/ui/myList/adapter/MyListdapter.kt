package com.dd.samplevideoplayer.ui.myList.adapter
...
class MyListdapter(val latestVideoCallBack: LatestVideoCallBack) : RecyclerView.Adapter<MyListdapter.ViewHolder>() {
    private lateinit var data: ArrayList<ContactEntity>
    ...
    fun setData(data: ArrayList<ContactEntity>) {
        let {
            it.data = data
        }
    }
    ...
    inner class ViewHolder(val binding: LayoutFunHorrorVideoBinding) :
        ...
        fun setData(position: Int) {
            ...
            binding.saveVideo.visibility=View.GONE
    ...
    interface LatestVideoCallBack{
        fun getData(data: ArrayList<ContactEntity>, position: Int,type:String)
    }
}