...
class LatestAdapter(val latestVideoCallBack: LatestVideoCallBack) :
    ...
    inner class ViewHolder(val binding: LayoutLatestBinding) :
        ...
        fun setData(position: Int) {
            ...
            binding.tvVideoDuration.text = "${data[position].views} Views| ${timeString}"
