...
class CateWiseVideo2Adapter(val latestVideoCallBack: LatestVideoCallBack) : RecyclerView.Adapter<CateWiseVideo2Adapter.ViewHolder>() {
    private lateinit var data: ArrayList<CatWiseVideoResponseData>
